      ...
      <div className="max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full">
        ...
        <div className="text-center">
          <p className="top-50 left-80 text-[#8892b0] py-4 max-w-[700px]">
            ...
            software engineer. I have mainly been involved with new
            technologies. <br /> These new technologies have allowed me to learn
            new programming languages and improve others from{" "}
            <b className="text-[#dd3333]">C# .NET to Solidity</b> (for Smart
            Contracts in Ethereum). I am also working in{" "}
            <b className="text-[#dd3333]">React JS and Javascript</b> in
            general.
          </p>
        </div>
      </div>
